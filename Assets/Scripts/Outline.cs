...
{
    private static HashSet<int> registeredMeshIds = new HashSet<int>();
    ...
    void Bake()
    {
        var bakedMeshes = new HashSet<int>();
        ...
        foreach (var meshFilter in GetComponentsInChildren<MeshFilter>())
        {
            ...
            int meshId = meshFilter.sharedMesh.GetInstanceID();

            if (!bakedMeshes.Add(meshId))
                continue;
    ...
    void LoadSmoothNormals()
    {
        foreach (var meshFilter in GetComponentsInChildren<MeshFilter>())
        {
            ...
            if (!registeredMeshIds.Add(meshId))
                continue;
        ...
        foreach (var skinnedMeshRenderer in GetComponentsInChildren<SkinnedMeshRenderer>())
        {
            ...
            int meshId = skinnedMeshRenderer.sharedMesh.GetInstanceID();
